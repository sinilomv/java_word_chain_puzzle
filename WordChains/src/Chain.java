...
public class Chain {
    ...
    public static void main(String[] args) {
        ...
        Set<String> dictionary = Chain.getDictionary(beginWord);
        List<List<String>> wordChains = Chain.getWordChains(beginWord, endWord, dictionary);
    ...
    public List<List<String>> getWordChains(String beginWord, String endWord, Set<String> dictionary) {
        ...
        breadthFirstSearch(beginWord, endWord, dictionary, neighbourNodes, distance);
        firstSearch(beginWord, endWord, neighbourNodes, distance, solution, res);

        return res;
    }

    // Use breadth first search to record every node's distance from the start node (level by level).
    private void breadthFirstSearch(String beginWord, String endWord, Set<String> dict,
...
//                int curDistance = distance.get(cur);
    ...
    private void firstSearch(String cur, String end, HashMap<String, ArrayList<String>> neighbourNodes,
        ...
        if(end.equals(cur)) {
           ...
           for(String next : neighbourNodes.get(cur)) {
                if(distance.get(next) == distance.get(cur)+1)
                    firstSearch(next, end, neighbourNodes, distance, solution, res);
            }
        }
    ...
    public Set<String> getDictionary(String beginWord) {
        ...
        try {
            ...
            // Instantiate the BufferedReader Classdeo
